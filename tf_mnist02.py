...
cross_entropy = tf.reduce_mean(-tf.reduce_sum(y_ * tf.log(y_conv1), reduction_indices = [1]))
...
for i in xrange(20000):
	...
	print("Teste accuracy  %g"%accuracy.eval(session = sess,feed_dict ={x:mnist.test.images, y_:mnist.test.labels, keep_prob:1.0}))
